...
//
// DEMO_AGENT is a Circle developer-controlled wallet on Arc testnet (chain 5042002): its payments
// are signed server-side by Circle (see circle-wallet/), not from a browser wallet. Any other
...
export const DEMO_AGENT: Address = "0xaa8437e8df6e3edfed3f9585e31c168200f16d1a";
